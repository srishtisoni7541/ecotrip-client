  ...
  const experiences = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1737064682445-b3529e30bf27?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTY1fHxub3JtYWwlMjBwZW9wbGVzJTIwcGljJTIwc2luZ2xlJTIwbWFuJTIwd29tZW4lMjB3aXRoJTIwc21pbHklMjBmYWNlfGVufDB8fDB8fHww",
    ...
    <section className="py-16   bg-gray-50 w-full">
      <div className="w-full px-28 mx-auto px-6">
        <div className="text-left mb-12">
          ...
          <p className="text-2xl text-gray-600">shared by our beloved Guests</p>
        </div>

        <div className="grid h-[80%] grid-cols-1 md:grid-cols-3 gap-6 ">
